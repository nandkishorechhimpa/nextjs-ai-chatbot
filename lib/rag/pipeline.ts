...
export const augmentQueryWithContext = async (userQuery: string): Promise<string> => {
    try {
        ...
        3. If the query is clearly unrelated (e.g., personal, entertainment, or general internet topics):
            a)Politely refuse with the same graceful message as above.
        4. Do not perform, assist with, or encourage any unofficial, personal, or unethical tasks.
