...
CREATE TABLE IF NOT EXISTS "content" (
	...
	"docId" uuid NOT NULL,
	"docCreatedAt" timestamp NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "content" ADD CONSTRAINT "content_docId_docCreatedAt_Document_id_createdAt_fk" FOREIGN KEY ("docId","docCreatedAt") REFERENCES "public"."Document"("id","createdAt") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
