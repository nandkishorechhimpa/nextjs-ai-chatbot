...
export const Fileupload: React.FC<FileUploadProps> = ({
    ...
    const handleDrop = (e: DragEvent<HTMLDivElement>) => {
        ...
        if (!isValidFile) {
            toast.error(`Invalid file type. Only ${accept}  are allowed.`);
            return;
        }
    ...
    return (
        <div className="col-span-full">
            ...
            <div
                className={`mt-2 flex justify-center rounded-lg border border-dashed px-6 py-10 transition-colors ${isDragging ? "border-primary bg-primary/10" : "border-gray-900/25"
                    }`}
